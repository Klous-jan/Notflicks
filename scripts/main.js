...
async function showMovieDataFour() {
	const api_key = "c410e49d7b8a0b61da272540eac14079";
	var result = await axios.get("https://api.themoviedb.org/3/discover/movie?with_genres=16&api_key=" + api_key + "&sort_by=revenue.desc");
	result = result.data.results;
...
async function showMovieDataSeven() {
	const api_key = "c410e49d7b8a0b61da272540eac14079";
	var result = await axios.get("https://api.themoviedb.org/3/discover/movie?primary_release_year=2005&api_key=" + api_key + "&sort_by=revenue.desc");
	result = result.data.results;
